...
`\lettrine[lines=3]{I}{n}`{=latex} Topic 3 the elements of $\Omega$ could be anything — heads/tails, defective/non-defective, expansion/contraction. The full machinery of calculus and algebra only becomes available once outcomes are *numbers*.
