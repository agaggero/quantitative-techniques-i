...
### 5.1.1 The discrete uniform (warm-up)
...
### 5.3.1 When does the binomial apply?
...
### 5.3.2 Shape of the binomial PMF
...
### 5.3.3 Worked example: factory defects
...
### 5.3.4 Business example: online returns
...
## 5.4 The Hypergeometric distribution {#sec-hypergeometric}
...
### 5.4.1 Worked example: lot inspection
...
### 5.4.2 Lottery example: Loter\'ia Primitiva
...
### 5.5.1 Conditions and typical scenarios
...
### 5.5.2 Worked example: call centre
...
### 5.5.3 Shape of the Poisson PMF
...
## 5.6 The Poisson approximation to the Binomial
...
### 5.6.1 Worked example: website complaints
...
### 5.7.2 Worked example: door-to-door sales
...
### 5.7.3 Business example: startup fundraising
...
## 5.8 The Negative Binomial (brief mention)
...
## 5.9 Identifying the right distribution
...
## 5.10 R Lab — PMFs, CDFs and the chocolate factory
...
### 5.10.1 Binomial: the d/p/q/r family
...
### 5.10.5 Geometric and the memoryless property
...
### 5.10.6 Binomial–Poisson approximation, visualised
