...
## 1.1 What statistics is — and is not
...
## 1.2 Statistical variables {#sec-variables}
...
## 1.3 Frequency tables and graphs

### 1.3.1 Ungrouped data {#sec-freqtable}
...
### 1.3.3 Graphical representations
...
## 1.4 Measures of central tendency {#sec-central}
...
### 1.4.6 Percentiles and quartiles {#sec-quartiles}
...
## 1.5 Measures of dispersion {#sec-dispersion}
...
### 1.5.1 Range and interquartile range
...
### 1.5.2 Variance and standard deviation
...
## 1.7 Measures of concentration {#sec-concentration}
...
## 1.8 R Lab — AirBnB nightly prices in Granada
...
### 1.8.5 Dispersion and the coefficient of variation
...
### 1.8.6 Comparing two markets with the CV
...
### 1.8.7 Histogram with mean and median
...
### 1.8.8 Skewness and excess kurtosis
...
### 1.8.9 Lorenz curve and Gini index
