...
`\lettrine[lines=3]{A}{}`{=latex} **time series** is a sequence of observations recorded at successive, equally spaced points in time. We denote the value at time $t$ by $Y_t$, so a series of length $n$ is written
