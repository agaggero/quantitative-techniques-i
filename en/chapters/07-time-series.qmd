...
### Moving averages vs.\ OLS — when to use which?
...
## Seasonal variation indices (IVE)
...
### The ratio-to-trend method (multiplicative)
...
### Multiplicative seasonal indices (IVE)
...
### Additive seasonal components (for contrast)
