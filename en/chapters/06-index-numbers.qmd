...
## Introduction: what is an index number?
...
## Rates of variation and growth factors
...
### Compounding: factors multiply, rates do not add
...
### The average rate of variation is a geometric mean
...
### Properties: identity, inversion, circular (chain) {#sec-index-properties}
...
## Composite (synthetic) indices: Laspeyres, Paasche, Fisher
...
### Substitution bias: which one tells the truth?
...
### Full worked example: three-good basket
...
## Quantity indices and the value decomposition
...
## Aggregating the CPI: sub-group weights and contributions {#sec-cpi-aggregation}
...
## Deflation: from nominal to real
...
## R Lab — A mini-CPI for a Granada student basket
...
### Elementary index for a single good
...
### Rates of variation and the geometric-mean average
...
### Student basket — Laspeyres, Paasche, Fisher (price)
...
### Deflation: nominal vs real student allowance
...
### Real-data example: Spanish minimum wage vs IPC
